...
% MADLM_forward.m (July 1, 2024)
%
% This script used to forward simulate BRF, specular and diffuse component of the dorsiventral leaf.
% _______________________________________________________________________
% ***********************************************************************
...
function [BRF_output,specular_output,diff_output]=MADLM_forward(a,wl,geomparams)
% a: Biochemical and structural parameters of MADLM model:
%    - Cab: Chlorophyll a+b content in ug/cm2
%    - Cxc: Carotenoids content in ug/cm2
